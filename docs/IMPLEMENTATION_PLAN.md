...
- **[code]** Level 3 (propose/execute actions after confirmation) — real net-new scope needing careful per-action confirmation UX; not started for any of the three.
