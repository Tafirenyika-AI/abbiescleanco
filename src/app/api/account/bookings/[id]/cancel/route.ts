...
import { cancelMyBooking } from "@/lib/server/clientPortalStore";
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const res = await cancelMyBooking(auth.ctx.customerId, id, typeof body.reason === "string" ? body.reason : undefined);
