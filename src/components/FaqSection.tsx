...
import { listFaqs } from "@/lib/server/content";

export default async function FaqSection() {
  const faqs = (await listFaqs(true)).sort((a, b) => a.sortOrder - b.sortOrder);
    ...
    <Section ariaLabelledby="faq-heading">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 divide-y divide-surface-200 rounded-2xl border border-surface-200">
          {faqs.map((faq) => (
            <details key={faq.id} className="group p-5 open:bg-surface-50">
