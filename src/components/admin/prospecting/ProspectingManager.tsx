    ...
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-admin-border bg-admin-card p-4">
        ...
        <p className="mt-1 text-xs text-admin-text-muted">
          {'Searches the open web broadly -- Craigslist (including its "jobs" section, for the private homeowners who post there by mistake instead of "services wanted"), Nextdoor, Facebook, Reddit, Thumbtack, Angi, TaskRabbit, local forums, plain Google-style searches, and wherever else a real result turns up -- for recent public posts where someone nearby is actively looking to hire a cleaner, not just businesses that might need one someday. Job ads from cleaning companies hiring their own staff are filtered out -- these are people paying for a cleaner, not competitors\' staffing posts. These rarely include a direct email/phone, so each one links to the real post for you to reply there yourself.'}
        </p>
        {!webSearchConfigured && (
