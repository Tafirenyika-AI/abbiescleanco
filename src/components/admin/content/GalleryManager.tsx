  ...
  return (
    <div className="rounded-2xl border border-surface-200 bg-white p-4">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-xs font-medium text-surface-700">Caption</span>
          <input
            value={form.caption}
        ...
        <label className="block">
          <span className="text-xs font-medium text-surface-700">Service type</span>
          <input
        ...
        <label className="block">
          <span className="text-xs font-medium text-surface-700">Category (kitchen/bathroom/living/hallway/laundry)</span>
          <input
            value={form.category}
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-dashed border-surface-300 p-4">
        ...
        />
        <button type="button" onClick={addItem} disabled={creating} className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-navy-950 px-4 py-2 text-sm font-semibold text-white hover:bg-navy-900 disabled:opacity-60">
