...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/customers", label: "Customers", icon: UserSquare2, permission: "MANAGE_LEADS", built: false },
    ],
  },
  {
    label: "Operations",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/reports", label: "Reports", icon: BarChart3, permission: "VIEW_REPORTS", built: false },
    ],
  },
  {
    label: "Growth",
