...
export const services: Service[] = [
  {
    ...
    imageAlt: "Tidy kitchen with a granite island and wood floors in a home kept up with standard cleaning",
    category: "home",
  },
  {
    id: "deep-cleaning",
    ...
    imageAlt: "Mop bucket, broom, dustpan, gloves and cleaning products ready for a deep clean",
    category: "home",
  },
  {
    id: "move-in-cleaning",
    ...
    image: "/images/service-movein.jpg",
    imageAlt: "Open kitchen with gray cabinets and stainless appliances, ready for a move-in cleaning",
    category: "specialty",
  },
  {
    ...
    image: "/images/service-moveout.jpg",
    imageAlt: "Kitchen with wood cabinets, island and hardwood-look floors ready for a move-out cleaning",
    category: "specialty",
  },
  {
    ...
    imageAlt: "Clean glass shower enclosure with tile walls and a granite ledge",
    category: "specialty",
  },
  {
    ...
    imageAlt: "Glass-top electric cooktop set into a granite kitchen island",
    category: "specialty",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Comfortable living room with leather recliners and a large TV",
    category: "home",
  },
  {
