...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "We serve Spokane Valley and nearby communities including Spokane, Liberty Lake, Millwood, Veradale, Greenacres, and Opportunity. Not sure if you're in range? Reach out and we'll let you know.",
  },
  {
    question: "Do I need to be home during the cleaning?",
    answer:
      "It's entirely up to you. Many customers share access instructions and go about their day; others prefer to be home. Just let us know your preference and any access details when you book.",
  },
  {
    question: "What products do you use?",
    answer:
      "We offer eco-conscious product options and are mindful of homes with pets and children. Let us know your preferences or any sensitivities when you request your estimate.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Weekly, every two weeks, every four weeks, or a custom schedule are all available. Future visits are scheduled once your recurring plan is confirmed with our team.",
  },
  {
